...
| verification run | `python3 scripts/run_quality_gates.py --config examples/quality-gates.json --repo . --pr-body-file tests/fixtures/pr_body/valid.md --output-json /tmp/quality-gates.json` -> exit 0 |
